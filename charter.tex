...
En la actualidad existe una tendencia creciente de monitoreo de parámetros dentro de los procesos productivos en general, con el objetivo de aumentar rendimientos, minimizar el uso de recursos y optimizar los resultados obtenidos. Esto puede extrapolarse al sector agrícola, donde la medición de parámetros involucrados en el desarrollo del fruto, tales como temperatura y humedad del sueldo, ayuda a mejorar la calidad el producto final obtenido.

La implementación de redes de sensores inalámbricas (WSN de sus siglas en ingles wireless sensor network) se ha visto disminuida en costos, principalmente por los avances tecnológicos en lo que respecta a capacidad de integración y diminución consumo, permitiendo la llegada a un mercado masivo.

El objetivo del desarrollo de la WSN como plataforma en sí, es permitir al cliente en particular elegir los parámetros que desea medir en sus cultivos y así dar una mayor personalización en la solución. Además, permite una generalización en el diseño ya que se parte de una base común que abarca la implementación de la red y los protocolos, permitiendo una fácil adaptación a los requerimiento de cada cliente.

Las principales ventajas del control de cultivos son:
