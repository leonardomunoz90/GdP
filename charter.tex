...
\item ocurrencia (O), del 1 al 10, siendo 10 el grado m´as alto de probabilidad de ocurrencia.
...
Riesgo 4: Dificultad en la implementación del protocolo de acceso al medio.
\begin{itemize}
	\item Severidad (S): 6,
