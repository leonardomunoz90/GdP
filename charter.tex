...
\titulo{Red de sensores inalámbricos de uso agrícola personalizable} 
...
\begin{enumerate}
	\item Requerimientos funcionales
		...
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\item El nodo gateway debe enviar los datos internet mediante la red celular.
				\item Cada módulo debe tener un identicador único.
				\item Se debe implementar confirmación de recepción de paquetes.
			...
			\begin{enumerate}
				...
				\item Todos los módulos deben enviar su porcentaje de batería restante de forma periódica.
	...
	\item Requerimientos de documentación.
		\begin{enumerate}
			\item Se debe documentar de manera clara el mecanismo de comunicación.
...
\item Riesgo alto(8): en caso de que esto no pueda lograrse, significaría un gran fracaso en el proyecto y requeriría de un replanteamiento de hardware y de topología de la red.
\end{itemize}
\textit{Story point}: 34.

Como usuario quiero que los nodos sensores sean versatiles para poder probar diferentes sensores y poder experimentar en función de los resultados.
\begin{itemize}
...
\item Desarrollo de módulos.
	...
	\item Enlace de comunicación (subtotal 160 h).
		\begin{enumerate}
			\item Implementación de protocolo dentro de la WSN (30 h).
			\item Desarrollo del método de enrutamiento automático (30 h).
			\item Definición de formato de tramas (15 h).
	...
	\item Armado (subtotal 120 h).
	
		\begin{enumerate}
			\item Diseño de esquemáticos (40 h).
			\item Armado y prueba de prototipo (20 h).
...
\item Documentación (subtotal 90 h).
	\begin{enumerate}
	\item Realizar reporte de testing (30 h).
	\item Redacción de manual de usuario (20 h).
	\item Redacción de memoria de trabajo final (40 h).
	\item Elaboración de presentación de proyecto (20 h).
	\end{enumerate}
	
\end{enumerate}

Total de horas del proyecto: 605 h.
