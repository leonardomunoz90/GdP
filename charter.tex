...
\begin{figure}[htpb]
\centering 
\includegraphics[width=.9\textwidth]{./Figuras/WSN_architecture.jpg}
...
Bajo este esquema, el proyecto requerirá del desarrollo de 3 módulos principales como se observa en la figura \ref{fig:DiagramaGeneral}:

\begin{itemize}
\item \uderline {Nodo con punto de acceso o gateway}:
\item \uderline {Nodo de enrutamiento}:
\item \uderline {Nodo sensor}:
\end{itemize}

\begin{figure}[htpb]
\centering 
\includegraphics[width=.9\textwidth]{./Figuras/DiagramaGeneral.jpg}
\caption{Arquitectura de una WSN}
