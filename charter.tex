...
\begin{itemize}
	\item Severidad (S): 9, si no pudiese implementarse el enlace de radio el proyecto sería completamente disfuncional, por lo que es necesario asegurar el establecimiento de dicho enlace.
...
Riesgo 1: Se buscará implementar protocolos que previamente fuesen probados en aplicaciones similares, de tal forma de asegurar su viabilidad de implementación en microcontroladores de pestaciones limitadas.
\begin{itemize}
\item Severidad (S): 
...
Riesgo 2: Siendo que el enlace de radio es uno de los elementos más críticos del proyecto, se le asignará una mayor prioridad temporal a la validación del enlace para poder confirmar el transceiver utilizado. De esta forma se minimiza el proceso de reingeniería en caso de ser necesario un cambio sobre dicho aspecto.
